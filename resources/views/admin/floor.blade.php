...
@section('content')
    <div class="table-toolbar">
        <button class="btn btn-op" id="remove" data-url="/admin/delete?t=floor">Delete</button>
        <a href="/admin/edit?t=floor"><button class="btn btn-op">Add</button></a>
    </div>
    <table id="table"
           data-toggle="table"
           data-url="/admin/list?t=floor"
