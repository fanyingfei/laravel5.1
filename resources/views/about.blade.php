...
$(function(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.19703,39.94277);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"北京嘉宜欣装饰有限公司",content:"1号楼305室",point:"116.197003|39.942853",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
