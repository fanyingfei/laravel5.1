    ...
    <div class="about-wrapper">
        ...
        <div class="about-list">
            @if ( $data['curr'] == '')
                <h2>关于我们</h2>
                <div class="about-us">
                    <p>北京嘉宜欣装饰有限公司成立于2013年6月，注册资金100万，是一家集装饰设计、工程施工、材料配送到管理与咨询的综合性的装饰公司。</p>
                    <p>公司成立之后一直将品牌声誉视同生命，以质量为本，设计为先的服务理念；以客户为中心，想客户之所想，全心全意做好服务；公司以准确的经营定位，独特的经营模式，以人为本的管理理念，使公司品牌口碑深入人心！</p>
                    <p>嘉宜欣以“省时，省力，省心，省钱，环保，安全。品质，售后七大模块为基础进行运营，确保在实际操作中能够落到实处。一直以来公司把成本降到最低，把一切好处回馈与信任的顾客。</p>
                    <p>自2014年起，嘉宜欣推出室内翻新服务，解决装饰遗留下来的各类问题，以墙面、地面为主的整体或局部出现的问题进行翻新服务。优秀的施工团队，专业的施工设备及流程，对技术不断的分析及研究，打造最完善的室内翻新服务！</p>
                    <p> 嘉宜欣室内翻新服务主要以住宅、公寓、办公、商业、酒店、学校、医院等场所的施工，历史成交量已达千户之多，受到大家的一致好评。
                    一套套用心的服务，装满一户户幸福的笑容，一次次专业的施工，绘成一张张行业的名片，嘉宜欣室内翻新服务凭其近几年的诚信服务一步一个脚印走向辉煌，获得大众的认可。
                    </p>
                    <p><strong>服务项目：</strong></p>
                    <p> 1、居家装饰、别墅、店铺装修、办公房装饰、学校厂房、中西式餐饮等精装修<br>
                       2、二手房简装、厨卫改装、水电安装<br>
                       3、涂料粉刷、墙面翻新、高档楼盘外墙涂料<br>
                       4、制作加工各企业，隔断、中高低档吊顶、瓷砖<br>
                       5、包门套、窗套，制作各类衣柜、办公桌、展示柜<br>
                       6、装饰配套工程、免漆木质门套、水电、各类装饰<br>
                       7、专业承接物业、小区、家庭、单位、酒店、学校、工厂、医院等建筑防水工程项目，真正做到"滴水不漏的承诺、万物不湿的保证"</p>
                 </div>
            @elseif ( $data['curr'] == 'bsk')
                ...
                <div class="query">
                    ...
                    <div class="result-list"><p><strong>例：</strong><span>姓名：王***</span><span>预约时间：2016-10-05</span><span>地址：浦东新区张江***</span><span>留言：***</span></p></div>
                </div>
            @elseif ( $data['curr'] == 'qua')
                ...
                <div class="query">
                    ...
                    <div class="result-list"><p><strong>例：</strong><span>姓名：王***</span><span>质保期：1年</span><span>2016.05.24-2017.05.24</span><span>地址：浦东新区张江***</span><span>留言：***</span></p></div>
                </div>
                ...
                if(obj.status == 'success'){
                    ...
                    $.each(obj.data, function(k, v) {
                        if(bt == 'all'){
                            ...
                            html += '<p><span>姓名：'+v.name+'</span><span>质保期：'+v.year+'年</span><span>'+v.keep_time+'</span><span>地址：'+v.address+'</span>';
                        }
